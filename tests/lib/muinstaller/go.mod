...
replace github.com/snapcore/snapd => github.com/ZeyadYasser/snapd v0.0.0-20241209094405-5241c53b4f73
...
require (
	...
	github.com/snapcore/secboot v0.0.0-20241003185103-eaa3655091fc // indirect
